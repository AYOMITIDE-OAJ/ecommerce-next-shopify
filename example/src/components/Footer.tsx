        ...
        <div className="px-6">
          <div className="container mx-auto flex text-gray-600 text-sm items-center justify-center">
            <div className="grid grid-flow-col gap-3">
              <a aria-label="GitHub" href="https://github.com/ayomitide-oaj" className="hover:text-indigo-500">
                <svg
              ...
              <a
                aria-label="Dribbble"
                href="https://ayomitide-oaj.github.io/"
                className="hover:text-indigo-500"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="ml-8">
              Copyright © <a href="https://ayomitide-oaj.github.io/">Ayomitide OAJ</a>
            </span>
          </div>
        </div>
      </div>
